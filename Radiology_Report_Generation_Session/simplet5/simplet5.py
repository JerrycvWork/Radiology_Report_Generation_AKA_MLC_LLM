...
class SimpleT5:
    ...
    def from_pretrained(self, model_type="t5", model_name="t5-base") -> None:
        ...
        """
        if model_type == "t5":
            print("Load Model Pretrained: ",model_type)
        ...
        elif model_type == "flan_t5_small":
            print("Load Model Pretrained: ", model_type)
            from transformers import AutoModelForSeq2SeqLM, AutoTokenizer
            self.model = AutoModelForSeq2SeqLM.from_pretrained("google/flan-t5-small")
            self.tokenizer = AutoTokenizer.from_pretrained("google/flan-t5-small")
        elif model_type == "flan_t5_base":
            print("Load Model Pretrained: ", model_type)
            from transformers import AutoModelForSeq2SeqLM, AutoTokenizer
            self.model = AutoModelForSeq2SeqLM.from_pretrained("google/flan-t5-base")
            self.tokenizer = AutoTokenizer.from_pretrained("google/flan-t5-base")
        elif model_type == "flan_t5_large":
            print("Load Model Pretrained: ", model_type)
            from transformers import AutoModelForSeq2SeqLM, AutoTokenizer
            self.model = AutoModelForSeq2SeqLM.from_pretrained("google/flan-t5-large")
            self.tokenizer = AutoTokenizer.from_pretrained("google/flan-t5-large")
        elif model_type == "flan_t5_xl":
            print("Load Model Pretrained: ", model_type)
            from transformers import AutoModelForSeq2SeqLM, AutoTokenizer
        ...
        ## Add bioGPT and other models
        elif model_type == "biogpt":
            print("Load Model Pretrained: ", model_type)
            from transformers import AutoTokenizer, BioGptForCausalLM,BioGptForTokenClassification
            self.tokenizer = AutoTokenizer.from_pretrained("microsoft/biogpt")
            self.model = BioGptForCausalLM.from_pretrained("microsoft/biogpt")

        elif model_type == "clinicalt5":
            print("Load Model Pretrained: ", model_type)
            from transformers import AutoTokenizer, AutoModelForSeq2SeqLM
            self.tokenizer = AutoTokenizer.from_pretrained("hossboll/clinical-t5")
            self.model = AutoModelForSeq2SeqLM.from_pretrained("hossboll/clinical-t5")

        elif model_type == "clinicalt5-official":
            print("Load Model Pretrained: ", model_type)
            from transformers import AutoTokenizer, T5ForConditionalGeneration
            self.tokenizer = AutoTokenizer.from_pretrained("luqh/ClinicalT5-base")
            self.model = T5ForConditionalGeneration.from_pretrained("luqh/ClinicalT5-base", from_flax=True)

        elif model_type == "clinicalt5_mimic":
            print("Load Model Pretrained: ", model_type)
            from transformers import AutoTokenizer, AutoModelForSeq2SeqLM
            self.tokenizer = AutoTokenizer.from_pretrained("pretrained_model/Clinical-T5-Base")
            self.model = AutoModelForSeq2SeqLM.from_pretrained("pretrained_model/Clinical-T5-Base")

        elif model_type == "clinicalt5_sci":
            print("Load Model Pretrained: ", model_type)
            from transformers import AutoTokenizer, AutoModelForSeq2SeqLM
            self.tokenizer = AutoTokenizer.from_pretrained("pretrained_model/Clinical-T5-Sci")
            self.model = AutoModelForSeq2SeqLM.from_pretrained("pretrained_model/Clinical-T5-Sci")


        ## Only for Ablation Study
        elif model_type == "bart":
            print("Load Model loading: ", model_type)
            from transformers import AutoTokenizer, AutoModelForSeq2SeqLM
            ...
            print("Load Model loading: ", model_type)
            from transformers import AutoTokenizer, AutoModelForSeq2SeqLM
            self.tokenizer = AutoTokenizer.from_pretrained("google/pegasus-x-base")
            self.model = AutoModelForSeq2SeqLM.from_pretrained("google/pegasus-x-base")

        elif model_type == "mt5small":
            print("Load Model loading: ", model_type)
            from transformers import AutoTokenizer, AutoModelForSeq2SeqLM
        ...
        self.T5Model_for_summary = LightningModel(
            tokenizer=self.tokenizer,
            model=self.model,
            outputdir="outputs/mimic_Tag_biogpt/",
            save_only_last_epoch=False,
        )

        print(ModelSummary(self.T5Model_for_summary))
    ...
    def train(
        ...
        max_epochs: int = 5,
        use_gpu: bool = True,
        outputdir: str = "outputs/mimic_Tag_biogpt/",
    ...
    def load_model(
        ...
        ## Add bioGPT and other models
            ...
            from transformers import AutoTokenizer, BioGptForCausalLM,BioGptForTokenClassification
            self.tokenizer = AutoTokenizer.from_pretrained(f"{model_dir}")
            self.model = BioGptForCausalLM.from_pretrained(f"{model_dir}")
            ...
            self.tokenizer = AutoTokenizer.from_pretrained(f"{model_dir}")
            self.model = AutoModelForSeq2SeqLM.from_pretrained(f"{model_dir}")
            print("Load Model Path: ",model_dir)
