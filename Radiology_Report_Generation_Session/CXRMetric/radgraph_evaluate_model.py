...
def evaluate_radgraph(ground_truth_path, generated_path,
    ...
    ## Try Calculate std
    std_entity_f1 = np.std([f1 for f1, _, _ in entity_f1s.values()])
    std_relation_f1 = np.std([f1 for f1, _, _ in relation_f1s.values()])
    print(f"STD RadGraph entity F1 = {std_entity_f1}\n"
          f"STD RadGraph relation F1 = {std_relation_f1}\n")
